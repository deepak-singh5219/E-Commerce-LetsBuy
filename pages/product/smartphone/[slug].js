...
function ProductDetails({smartphone,smartphones}) {
        ...
        <div className="product-detail-container">
            ...
            <div className="product-detail-desc">
                ...
                <div className="buttons">
                    <button onClick={() => onAdd(smartphone,qty) } className="add-to-cart">Add to cart</button>
...
export const getStaticProps  = async ({params:{slug}}) => {
    ...
    const smartphonesQuery = '*[_type == "smartphone"]';
    const smartphones = await client.fetch(smartphonesQuery);
  
  
    
  
    return {
      props: { smartphone, smartphones},
    };
  };
  ...
  export const getStaticPaths = async () => {
    ...
    const smartphones = await client.fetch(query);
    const paths = smartphones.map((product) => ({
        params: {
